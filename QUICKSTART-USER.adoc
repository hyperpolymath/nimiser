...
// Replace nimiser, Nimiser — See README.adoc for details., just run, Nimiser started successfully. with actuals
= nimiser — Quick Start for Users
:toc:
:toclevels: 2

== What is nimiser?

Nimiser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./nimiser-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/nimiser/wiki
